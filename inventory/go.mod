module github.com/akaporn-katip/gohex-example/inventory

go 1.26

require (
	github.com/akaporn-katip/gohex-example/contracts v0.0.0
	...
	github.com/akaporn-katip/gohex/cqrs-postgres v0.1.0
...
// contracts is part of this repo and never published; resolve it locally.
replace github.com/akaporn-katip/gohex-example/contracts => ../contracts
