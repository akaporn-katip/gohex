...
- [gohex Framework](https://github.com/akaporn-katip/gohex/blob/main/CONTEXT.md) — the framework's own language: aggregates, events, relay, sagas, projections
- [Ordering](./ordering/CONTEXT.md) — receives and tracks customer orders
- [Billing](./billing/CONTEXT.md) — captures and refunds payments
- [Inventory](./inventory/CONTEXT.md) — tracks stock levels and reservations
- [Shipping](./shipping/CONTEXT.md) — creates and dispatches shipments
