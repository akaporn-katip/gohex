module github.com/akaporn-katip/gohex/projection-postgres

go 1.26

require (
	github.com/akaporn-katip/gohex/broker v0.0.0
	github.com/akaporn-katip/gohex/projection v0.0.0
	github.com/jackc/pgx/v5 v5.7.6
)

require (
	github.com/akaporn-katip/gohex/eventstore v0.0.0 // indirect
	github.com/akaporn-katip/gohex/kernel v0.0.0 // indirect
...
replace (
	...
	github.com/akaporn-katip/gohex/projection => ../projection
)
