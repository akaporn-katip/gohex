module github.com/akaporn-katip/gohex/services/inventory
...
require (
	...
	github.com/akaporn-katip/gohex/libs/cqrs-postgres v0.0.0
...
replace (
	...
	github.com/akaporn-katip/gohex/libs/cqrs-postgres => ../../libs/cqrs-postgres
